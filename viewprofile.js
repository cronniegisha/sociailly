...
for (let i = 1; i <= localStorage.length; i++) {
    ...
    photoSpan.imageContent='Upload Photo'
    ...
    divphoto.appendChild(photoSpan)
    ...
    divphoto.classList.add('profile-group')
    ...
    profileContainer.appendChild(divphoto)
